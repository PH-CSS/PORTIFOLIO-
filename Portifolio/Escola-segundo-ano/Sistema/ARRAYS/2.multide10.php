...
<body>
    ...
    if (ISSET($_GET["enviar"])) {
        ...
        foreach ($lista as $key => $value) {
            $novoNumMult = $value * $numnew;
        $algo =  $algo ."<br>" . $value . " => " . $novoNumMult;   
        };


        $res = "<br>" . "Número multiplicado = " . $numnew . "<br>" . $algo ;
    ...
    <form action="" method="get">
        ...
        <hr>
        <label for='numnew'>Número multiplicador </label>
        <br>
        <input type='number' name='numnew' id='numnew' value = "<?php $numnew = ISSET($_GET['numnew'])? $_GET['numnew']: 1  ?>" required>
